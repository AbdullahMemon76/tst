  ...
  return (
    <div className="min-h-screen bg-gray-100 relative">
        ...
        <div className="container mx-auto flex items-center px-4">
          ...
          <nav>
            <ul className="flex space-x-6 text-gray-700 ml-4">
              <li><a href="#" className="hover:text-blue-600">Commission</a></li>
      ...
      <div className="text-center mt-8">
        <img src="/logo.png" alt="Ozumi Yashoda Logo" className="mx-auto h-20" />
      ...
      <section id="art-examples" className="p-8 bg-white shadow-lg my-4 mx-4 rounded-lg">
          ...
          <div className="min-h-screen bg-white flex justify-center items-center p-3">
            <div className="grid grid-cols-3 gap-6 w-full max-w-6xl">
              ...
              <div className="border-2 border-gray-300 p-4 flex justify-center items-center bg-white shadow-lg rounded-lg">
                <img src="/banimage1.jpg" alt="Image 1" className="w-full h-auto object-cover" />
              </div>

              {/* Frame 2 */}
              <div className="border-2 border-gray-300 p-4 flex justify-center items-center bg-white shadow-lg rounded-lg">
                <img src="/banimage2.jpg" alt="Image 2" className="w-full h-auto object-cover" />
              </div>

              {/* Frame 3 */}
              <div className="border-2 border-gray-300 p-4 flex justify-center items-center bg-white shadow-lg rounded-lg">
                <img src="/banimage3.jpg" alt="Image 3" className="w-full h-auto object-cover" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-2 border-gray-300 p-4 flex justify-center items-center bg-white shadow-lg rounded-lg">
          <img src="/illus.jpg" alt="Image 2" className="max-h-3xl w-full object-cover" />
        </div>
      ...
      <h3 className="text-4xl font-medium text-center text-black mt-6">3D VTUBER MODELS</h3>
          <div className="min-h-screen bg-white flex justify-center items-center p-3">
            <div className="grid grid-cols-3 gap-6 w-full max-w-6xl">
              {/* Frame 1 */}
              <div className="border-2 border-gray-300 p-4 flex justify-center items-center bg-white shadow-lg rounded-lg">
                <img src="/comic1.jpg" alt="Image 1" className="w-full h-auto object-cover" />
              </div>

              {/* Frame 2 */}
              <div className="border-2 border-gray-300 p-4 flex justify-center items-center bg-white shadow-lg rounded-lg">
                <img src="/comic2.jpg" alt="Image 2" className="w-full h-auto object-cover" />
              </div>

              {/* Frame 3 */}
              <div className="border-2 border-gray-300 p-4 flex justify-center items-center bg-white shadow-lg rounded-lg">
                <img src="/comic3.jpg" alt="Image 3" className="w-full h-auto object-cover" />
              </div>
            </div>
          </div>
        </div>
